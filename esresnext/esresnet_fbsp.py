...
from .transforms import frame_signal
from .esresnet_base import _ESResNet
from .esresnet_base import Bottleneck
...
class ESResNeXtFBSP(_ESResNetFBSP):
    ...
    def loading_func(*args, **kwargs):
        if tv is None:
            raise ImportError("torchvision is required for pretrained loading")
        return tv.models.resnext50_32x4d(*args, **kwargs)
